...
"""
function trajectory(x0::NTuple{3, T}, v0::NTuple{3, T}, ddx::Function;
        alg=Tsit5(), rmin::Real=LUNAR_RADIUS, rmax::Real=1e9, tspan::Tuple=(0f0,1f10),
        kwargs...) where {T<:AbstractFloat}

    x0 = SA{T}[x0 ./ norm(x0) .* (rmin + 1) ...] # normalize starting position to surface
    v0 = SA[v0...]

    # function _f!(ddu, du, u, p, t); ddu .= SA[ddx(u, du)...]; end
